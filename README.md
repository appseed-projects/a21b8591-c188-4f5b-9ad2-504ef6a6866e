...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-14 19:39`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a21b8591-c188-4f5b-9ad2-504ef6a6866e.git
$ cd a21b8591-c188-4f5b-9ad2-504ef6a6866e
```
